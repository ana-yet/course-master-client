...
export default function CreateCoursePage() {
  ...
  const [expandedModule, setExpandedModule] = useState(null); // { milestone: 0, module: 0 }
  ...
  const [form, setForm] = useState({
    ...
    level: "Beginner",
    thumbnail: "https://i.ibb.co.com/TD056y0X/default.png",
    batch: "",
    startDate: "",
    milestones: [],
  });
  ...
  const removeQuizQuestion = (milestoneIndex, moduleIndex, questionIndex) => {
    const newMilestones = [...form.milestones];
    newMilestones[milestoneIndex].modules[moduleIndex].quiz.questions =
      newMilestones[milestoneIndex].modules[moduleIndex].quiz.questions.filter(
        (_, i) => i !== questionIndex
      );
    setForm({ ...form, milestones: newMilestones });
  };
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div>
        ...
        <p className="text-slate-500">
          Build your course with milestones, modules, quizzes, and assignments
        </p>
      </div>
                        ...
                        {milestone.modules.length === 0 ? (
                          <div className="text-center py-6 bg-slate-50 rounded-lg border border-dashed border-slate-200">
                            <p className="text-sm text-slate-500">
                              No modules yet. Add modules with video lessons and
                              quizzes.
                            </p>
                          </div>
                        ) : (
                        ...
                        <div className="bg-amber-50 p-4 rounded-lg border border-amber-100 space-y-4">
                          <div className="grid gap-3 md:grid-cols-2">
                            ...
                            <Input
                              label="Max Score"
                              type="number"
                              value={milestone.assignment.maxScore}
                              onChange={(e) =>
                                updateAssignment(
                                  mIndex,
                                  "maxScore",
                          ...
                          <Input
                            ...
                            type="number"
                            value={milestone.assignment.deadline}
                            onChange={(e) =>
                              updateAssignment(
                                mIndex,
                                "deadline",
